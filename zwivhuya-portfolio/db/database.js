...
function seedData() {
  ...
  // Columns: title, description, tech_stack, github_url, live_url, featured, year
  const projects = [
    [
      ...
      'React Native, Node.js, Express.js, PostgreSQL, JWT, Expo Go, REST API, Git',
      'https://github.com/Mathadaz/Rental',
      null,   // live_url
      1,      // featured
      2025    // year
    ],
    [
      ...
      'https://github.com/Mathadaz/Shoes-E-commerce',
      'https://github.com/Mathadaz/Shoes-E-commerce-Main',  // live_url
      1,      // featured
      2024    // year
    ],
    [
    ...
    [
      ...
      'A dashboard system developed for managing rental properties, developed as a personal project. Implemented a FastAPI backend with RESTful APIs and a React + Vite frontend, using SQLite3 for data storage (PostgreSQL / MySQL to be considered for Production) and JWT for secure authentication.',
      'Python FastAPI, Tailwind, React.js, SQLite3, JWT, VSCode',
      'https://github.com/Mathadaz/Rental_Management_System',
      null,   // live_url
      1,      // featured
      2026    // year
    ],
    [
      'AutoCrib Car Rentals Web App',
      'A fully optimised cross-platform web application for renting cars, built as a personal project. Serves as the main developer, delivering scalable solutions with real-time booking, secure JWT authentication, and a PostgreSQL backend powering a smooth delivery experience.',
      'Python Django, React.js, PostgreSQL, JWT, REST API, Git',
      'https://github.com/Mathadaz/AutoCrib-App',
      null,   // live_url
      1,      // featured
      2025    // year
    ],
